...
<template>
    <div>
        ...
        <p>
            <strong id="lastUpdated">Last updated September 10, 2023</strong>
        </p>
        <p>
            This privacy notice for {{$constants.main.botName}} our, describes how and why we might collect, store, use, and/or share process
            your information when you use our services, such as when you:
        </p>
        <ul class="list-disc pl-8">
            <li>Visit our website at <a :href="$constants.main.websiteHostName">{{ $constants.main.websiteHostName }}</a>, or any website
                of ours that links to this privacy notice.
            </li>
            <li>Download and use our mobile application ({{$constants.main.botName}}), or any other application of ours that links to this
                privacy notice.
            </li>
        ...
        <p>
            <strong>
                <i>
                    ...
                    but you can find out more details about any of these topics by clicking the link following each key
                    point or by using our table of contents below to find the section you are looking for.
                    You can also click <a href="#tableOfContents">here</a> to go directly to our table of contents.
                </i>
            </strong>
        </p>
        <p>
            <strong>What personal information do we process?</strong> When you visit, use, or navigate our Services,
            we may process personal information depending on how you interact with {{$constants.main.botName}} and the Services,
            the choices you make, and the products and features you use. Click <a href="#collect">here</a> to learn
            more.
        </p>
        <p>
            ...
            applicable law.
            Click <a href="#sensitiveInformation">here</a> to learn more.
        </p>
        <p>
            ...
            Click <a href="#processPersonalInfo">here</a> to learn more.
        </p>
        <p>
            <strong>In what situations and with which parties do we share personal information?</strong>
            We may share information in specific situations and with specific third parties.
            Click <a href="#sharePersonalInfo">here</a> to learn more.
        </p>
        <p>
            ...
            be 100% secure,
            so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not
            be able to defeat our security and improperly collect, access, steal, or modify your information.
            Click <a href="#informationSafe">here</a> to learn more.
        </p>
        <p>
            ...
            Click <a href="#rights">here</a> to learn more.
        </p>
        <p>
            ...
            <a :href="$constants.main.websiteHostName + '/account/data-request'">{{ $constants.main.websiteHostName }}/data-request</a>,
            or by contacting us. We will consider and act upon any request in accordance with applicable data protection
            laws.
        </p>
        <p>
            Want to learn more about what {{$constants.main.botName}} does with any information we collect?
            Click <a href="#doesWithInfo">here</a> to review the notice in full.
        </p>
        <div class="clearfix"></div>
        <h5 id="tableOfContents">TABLE OF CONTENTS</h5>
        <ol class="list-decimal pl-8">
            <li><a href="#collect">WHAT INFORMATION DO WE COLLECT?</a></li>
            <li><a href="#howProcessPersonalInfo">HOW DO WE PROCESS YOUR INFORMATION?</a></li>
            <li><a href="#processPersonalInfo">WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</a>
            </li>
            <li><a href="#sharePersonalInfo">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a></li>
            <li><a href="#track">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
            <li><a href="#socialLogin">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a></li>
            <li><a href="#keepInfo">HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
            <li><a href="#informationSafe">HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
            <li><a href="#rights">WHAT ARE YOUR PRIVACY RIGHTS?</a></li>
            <li><a href="#track">CONTROLS FOR DO-NOT-TRACK FEATURES</a></li>
            <li><a href="#residents">DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
            <li><a href="#update">DO WE MAKE UPDATES TO THIS NOTICE?</a></li>
            <li><a href="#contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></li>
            <li><a href="#review">HOW CAN YOU REVIEW YOUR PROVIDED PERSONAL DATA?</a></li>
            <li><a href="#updatingData">Updating Data</a></li>
            <li><a href="#temporarilyData">Temporarily Stored Information</a></li>
            <li><a href="#removalOfData">Removal of Data</a></li>
        </ol>

        <h5 id="collect">1. WHAT INFORMATION DO WE COLLECT?</h5>
        ...
        <ul class="list-disc pl-8">
            ...
            <li>Warning log data (for max 5 years)</li>
            <li>Correction log data (for max 5 years)</li>
            <li>Ban log data (for max 5 years after banning)</li>
            <li>Any information that you provide for the profile system</li>
        </ul>
        <p id="sensitiveInformation">
        ...
        <p>
            ...
            All payment data is stored by Stripe. You may find their privacy notice links here: <a
            href="https://stripe.com/privacy">https://stripe.com/privacy</a>.
        </p>
        <p>
            ...
            we will collect the information described in the section called <a href="#socialLogin">"HOW DO WE HANDLE
        ...
        <ul class="list-disc pl-8">
            <li>
                ...
                to provide certain location-based services. If you wish to change our access or permissions, you may do
            ...
            <li>
                ...
                browser type and version, hardware model Internet service provider and/or mobile carrier, and Internet
                Protocol (IP) address (or proxy server).
                If you are using our application(s), we may also collect information about the phone network associated
            ...
            <li>
                ...
                application(s).
                If you wish to opt out from receiving these types of communications, you may turn them off in your
                device's settings.
        ...
        <p>
            ...
            more about this in our Cookies Policy: <a
            :href="$constants.main.websiteHostName + '/about/cookies'">{{ $constants.main.websiteHostName }}/about/cookies</a>.
        </p>
        <p>
        ...
        <h5 id="howProcessPersonalInfo">2. HOW DO WE PROCESS YOUR INFORMATION?</h5>
        <p>
            <i>
                <strong>In Short:</strong> <i>We process your information to provide, improve, and administer our
                Services, communicate with you, for security and fraud prevention, and to comply with law. We may also
                process your information for other purposes with your consent.</i>
            </i>
        </p>
        ...
        <ul class="list-disc pl-8">
            ...
            <li><strong>To fulfill and manage your orders.</strong> We may process your information to fulfill and
                manage your orders, payments, returns, and exchanges made through the Services.
            </li>
            <li><strong>To administer prize draws and competitions.</strong> We may process your information to
        ...
        <h5 id="processPersonalInfo">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h5>
        <p>
            <i>
        ...
        <p>
            ...
            or in situations where your permission can be inferred (i.e., implied consent). You can withdraw your
            consent at any time. Click <a href="#withdrawing">here</a> to learn more.
        </p>
        <p>
        ...
        <ul class="list-disc pl-8">
            ...
            <li>If we have reasonable grounds to believe an individual has been, is, or may be victim of financial
                abuse.
            </li>
        ...
        <h5 id="sharePersonalInfo">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h5>
        <p>
            <i>
                <strong>In Short: We may share information in specific situations described in this section and/or with
                    the following third parties.</strong>
            </i>
        </p>
        <p>
        ...
        <ul class="list-disc pl-8">
            ...
            <li><strong>Offer Wall.</strong> Our application(s) may display a third-party hosted "offer wall." Such an
                offer wall allows third-party advertisers to offer virtual currency, gifts, or other items to users in
                return for the acceptance and completion of an advertisement offer. Such an offer wall may appear in our
                application(s) and be displayed to you based on certain data, such as your geographic area or
                demographic information. When you click on an offer wall, you will be brought to an external website
                belonging to other persons and will leave our application(s). A unique identifier, such as your user ID,
        ...
        <h5 id="track">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h5>
        <p>
            <i>
        ...
        <p>
            ...
            is set out in our Cookies Policy: <a
            :href="$constants.main.websiteHostName + '/about/cookies'">{{ $constants.main.websiteHostName }}/about/cookies</a>.
        </p>
        <h5 id="socialLogin">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h5>
        <p>
            <i>
        ...
        <p>
            ...
            details (like your Facebook, Twitter or Discord logins). Where you choose to do this, we will receive
            certain profile information about you from your social media provider. The profile information we receive
        ...
        <h5 id="informationSafe">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h5>
        <p>
            <i>
        ...
        <h5 id="rights">9. WHAT ARE YOUR PRIVACY RIGHTS?</h5>
        <p>
            <i>
                <strong>In Short:</strong> In some regions, such as Canada, you have rights that allow you greater
                access to and control over your personal information. You may review, change, or terminate your account
                at any time.
            </i>
        </p>
        <p>
            ...
            details provided in the section <a href="">"HOW CAN YOU CONTACT US ABOUT THIS NOTICE?"</a> below.
        </p>
        <p>
        ...
        <h5 id="residents">11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h5>
        <p>
            <i>
        ...
        <ul class="list-disc pl-8">
            <li>(1) every individual who is in the State of California for other than a temporary or transitory purpose
                and
            </li>
            <li>(2) every individual who is domiciled in the State of California who is outside the State of California
        ...
        <table style="width: 100%;">
            <tbody>
                <tr>
                    ...
                    <td style="width: 14.9084%; border-right: 1px solid white; border-top: 1px solid white; text-align: center;">
                    <span>
                        <span>
                            <span>
                ...
                <tr>
                    ...
                    <td style="width: 51.4385%; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>Name, contact information, education, employment, employment history, and financial information</span></span></span>
                        </div>
                    </td>
                    <td style="width: 14.9084%; text-align: center; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><br></div>
                        <div style="line-height: 1.5;"><span><span><span><span class="block-component"></span>YES<span
                            class="statement-end-if-in-editor"></span></span></span></span></div>
                        <div style="line-height: 1.5;"><br></div>
                    </td>
                </tr>
                <tr>
                    <td style="width: 33.8274%; border-left: 1px solid white; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>C. Protected classification characteristics under California or federal law</span></span></span>
                        </div>
                    </td>
                    <td style="width: 51.4385%; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>Gender and date of birth</span></span></span>
                        </div>
                    </td>
                    <td style="width: 14.9084%; text-align: center; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><br></div>
                ...
                <tr>
                    <td style="width: 33.8274%; border-left: 1px solid white; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>D. Commercial information</span></span></span>
                        </div>
                    </td>
                    <td style="width: 51.4385%; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>Transaction information, purchase history, financial details, and payment information</span></span></span>
                        </div>
                    </td>
                    <td style="width: 14.9084%; text-align: center; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><br></div>
                ...
                <tr>
                    <td style="width: 33.8274%; border-left: 1px solid white; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>E. Biometric information</span></span></span>
                        </div>
                    </td>
                    <td style="width: 51.4385%; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;">
                            <span><span><span>Fingerprints and voice prints</span></span></span></div>
                    </td>
                    <td style="width: 14.9084%; text-align: center; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><br></div>
                        <div style="line-height: 1.5;"><span><span><span><span class="block-component"></span>NO<span
                            class="statement-end-if-in-editor"></span></span></span></span></div>
                        <div style="line-height: 1.5;"><br></div>
                    </td>
                </tr>
                <tr>
                    <td style="width: 33.8274%; border-left: 1px solid white; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;">
                            <span><span><span>F. Internet or other similar network activity</span></span></span></div>
                    </td>
                    <td style="width: 51.4385%; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>Browsing history, search history, online <span
                            class="block-component"></span>behavior<span class="statement-end-if-in-editor"></span>, interest data, and interactions with our and other websites, applications, systems, and advertisements</span></span></span>
                        </div>
                    </td>
                    <td style="width: 14.9084%; text-align: center; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><br></div>
                ...
                <tr>
                    <td style="width: 33.8274%; border-left: 1px solid white; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>G. Geolocation data</span></span></span></div>
                    </td>
                    <td style="width: 51.4385%; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>Device location</span></span></span></div>
                    </td>
                    <td style="width: 14.9084%; text-align: center; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><br></div>
                        <div style="line-height: 1.5;"><span><span><span><span class="block-component"></span>YES<span
                ...
                <tr>
                    <td style="width: 33.8274%; border-left: 1px solid white; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>H. Audio, electronic, visual, thermal, olfactory, or similar information</span></span></span>
                        </div>
                    </td>
                    <td style="width: 51.4385%; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>Images and audio, video or call recordings created in connection with our business activities</span></span></span>
                        </div>
                    </td>
                    <td style="width: 14.9084%; text-align: center; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><br></div>
                ...
                <tr>
                    <td style="width: 33.8274%; border-left: 1px solid white; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>I. Professional or employment-related information</span></span></span>
                        </div>
                    </td>
                    <td style="width: 51.4385%; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><span><span><span>Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us</span></span></span>
                        </div>
                    </td>
                    <td style="width: 14.9084%; text-align: center; border-right: 1px solid white; border-top: 1px solid white;">
                        <div style="line-height: 1.5;"><br></div>
                ...
                <tr>
                    <td style="border-left: 1px solid white; border-right: 1px solid white; border-top: 1px solid white; width: 33.8274%;">
                        <div style="line-height: 1.5;"><span><span><span>J. Education Information</span></span></span>
                        </div>
                    </td>
                    <td style="border-right: 1px solid white; border-top: 1px solid white; width: 51.4385%;">
                        <div style="line-height: 1.5;">
                            <span><span><span>Student records and directory information</span></span></span></div>
                    </td>
                ...
                <tr>
                    <td style="border-width: 1px; border-color: white; border-style: solid; width: 33.8274%;">
                        <div style="line-height: 1.5;"><span><span><span>K. Inferences drawn from other personal information</span></span></span>
                        </div>
                    </td>
                    <td style="border-bottom: 1px solid white; border-top: 1px solid white; border-right: 1px solid white; width: 51.4385%;">
                        <div style="line-height: 1.5;"><span><span><span>Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics</span></span></span>
                        </div>
                    </td>
                    <td style="text-align: center; border-right: 1px solid white; border-bottom: 1px solid white; border-top: 1px solid white; width: 14.9084%;">
                        <div style="line-height: 1.5;"><br></div>
                        <div style="line-height: 1.5;"><span><span><span><span class="block-component"></span>YES<span
                            class="statement-end-if-in-editor"><span></span></span></span></span></span></div>
                        <div style="line-height: 1.5;"><br></div>
                    </td>
                </tr>
            </tbody>
        ...
        <p>
            {{$constants.main.botName}} has not disclosed or sold any personal information to third parties for a business or commercial
            purpose in the preceding twelve (12) months. {{$constants.main.botName}} will not sell personal information in the future
        ...
        <h5 id="update">12. DO WE MAKE UPDATES TO THIS NOTICE?</h5>
        <p>
            <i>
        ...
        <p>
            We reserve the right to update these terms at our own discretion, giving you a 1-Week (7 days) period to opt
            out of these terms if you're not agreeing with the new changes.<br>
        ...
        <p>
            You have the right to request access to the personal information we collect from you, please visit: <a
            :href="$constants.main.websiteHostName + '/account/data-request'">{{ $constants.main.websiteHostName }}/data-request</a>.
        </p>

        <h5 id="updatingData">15. Updating Data</h5>
        <p>
            The data may be updated when using specific commands.
            Updating data will require the input of an end user, and data that can be seen as sensitive, such as content
            of a message, may need to be stored when using certain commands or by interacting with our website.
        </p>
        <p>
            No other actions may update the stored information at any given time.
        </p>
        <h5 id="temporarilyData">16. Temporarily Stored Information</h5>
        <p>
            The Bot may keep the stored information in an internal caching mechanic for a certain amount of time or it
            may use <a href="https://redis.io/">Redis</a> which is a caching database system.
            After this time period, the cached information will be dropped and only be re-added when required.
        </p>
        <p>
            Data might be dropped from cache pre-maturely through actions such as removing the bot from the Server.
        </p>
        <h5 id="removalOfData">17. Removal of Data</h5>
        <p>
            We may delete any data from our database at anytime.
        </p>

        <h6>Some data will be kept for Legitimate Interest that data is described in <a href="#doesWithInfo">Personal Information Provided by You.</a></h6>
        ...
        <div class="accordion" id="accordionExample">
            <accordion-item :show="true" :closeable="false" title="Technical limitations">
                <template #body>
                    <span>
                        The automatic removal of data has certain limitations that we cannot fix or avoid.<br>
                        Limitations include, but aren't limited to, downtime of the bot due to maintenance or
                        technical issues at our hosting provider or Discord Inc.
                    </span>
                    <p class="no-padding">In such events can you request <a href="#removalOfData">manual removal</a>
                        through email under the above mentioned conditions.</p>
                </template>
            </accordion-item>
        </div>
    </div>
